...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyqtconsole-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15091&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyqtconsole-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyqtconsole` can be installed with:

```
conda install pyqtconsole
```

It is possible to list all of the versions of `pyqtconsole` available on your platform with:
